...
if "%VERSION%" EQU "%VERSIONCHECK%" ( goto Alert
) else goto Updater
...
if /i "%choice%"=="17" goto:SystemAuto-Loggers
if /i "%choice%"=="X" exit /b
if /i "%choice%"=="B" goto Title
...
:AudioOptions
cd "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\"
if exist "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\Nssm.exe" ( goto Real ) else ( goto Downloadnssm )
:Downloadnssm
...
goto Real
:Real
if exist "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\REAL.exe" ( goto ContinueAudioOptions ) else ( goto DownloadREAL )
:DownloadREAL
...
:SoftRestart
if exist "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\NSudo.exe" ( goto NSudo ) else ( goto DownloadNSudo )
:DownloadNSudo
...
if exist "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\Restart64.exe" ( goto EmptyStandbyList ) else ( goto DownloadRestart64 )
:DownloadRestart64
...
:EmptyStandbyList
if exist "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\EmptyStandbyList.exe" ( goto ContinueSoftRestart ) else ( goto DownloadEmptyStandbyList )
