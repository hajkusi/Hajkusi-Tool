...
If %Input% EQU Zgadzam_Sie ( goto Disclaimer ) else ( goto Alert )
:Disclaimer
...
if exist "%SYSTEMDRIVE%\Hajkusi-Tool\Resources\Restart" ( goto EmptyStandbyList ) else ( goto DownloadRestart64 )
:DownloadRestart64
